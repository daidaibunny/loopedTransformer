...
QUERY_RECURRENT_ARCHITECTURE = "query_only_history_recurrent_no_lora_v4_candidate"
QUERY_RECURRENT_PROTOCOL = "single_stage_fixed_recurrence_unit_residual_v4_candidate"
